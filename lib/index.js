...
const getOptions = function(config, options) {
    ...
    // we need. So we cqn get rid of lodash which is vulnerable about
    // every second week... 
        ...
        return {
            send: (options, cb) => {
                return new Promise((resolve, reject) => {
                    // This check is more accurate then the loadash version for what we
                    // need. So we cqn get rid of lodash which is vulnerable about every
                    // second week...
